...
for backwards compatibility with Java code generated with Dafny versions earlier than 4.3.".TrimStart()) {
  ...
  protected override SinglePassCodeGenerator CreateCodeGenerator() {
    return new JVerifyCodeGenerator(Options, Reporter);
  }
  ...
  public JVerifyBackend(DafnyOptions options) : base(options) {
  }
}
