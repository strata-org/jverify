...
namespace Microsoft.Dafny.Compilers {
  public class JVerifyCodeGenerator : SinglePassCodeGenerator {
    ...
    protected class ClassWriter : IClassWriter {
      public readonly JVerifyCodeGenerator CodeGenerator;
      ...
      public ClassWriter(JVerifyCodeGenerator codeGenerator, ConcreteSyntaxTree instanceMemberWriter, ConcreteSyntaxTree ctorBodyWriter, ConcreteSyntaxTree staticMemberWriter = null) {
    ...
    string TypeParameters(List<TypeParameter>/*?*/ targs, string suffix = "") {
      ...
      return $"<{targs.Comma(IdName)}>{suffix}";
    }
    ...
    protected override IClassWriter CreateClass(string moduleName, bool isExtern, string /*?*/ fullPrintName,
      ...
      if (cls is DefaultClassDecl || (
            ...
            !Options.Get(JVerifyBackend.LegacyDataConstructors))) {
    ...
    IClassWriter CompileDatatypeBase(DatatypeDecl dt, ConcreteSyntaxTree wr) {
      ...
      if (dt.TypeArgs.Count == 0) {
        ...
        if (Options.Get(JVerifyBackend.LegacyDataConstructors)) {
      ...
      foreach (var ctor in dt.Ctors.Where(ctor => !ctor.IsGhost)) {
        ...
        if (dt.TypeArgs.Any() && Options.Get(JVerifyBackend.LegacyDataConstructors)) {
          wr.WriteLine("@Deprecated()");
          wr.Write($"public static{justTypeArgs} {DtT_protected} {DtCreateName(ctor)}(");
