...
public class JVerify {
    ...
    /**
     * Tell JVerify which value decreases on each - iteration of the loop, when used in a loop -
     * recursive call, when used on a recursive method Knowing which value decreases is required for
     * termination proofs
     */
     ...
     * This is only necessary within {@link Pure} methods, which otherwise cannot read the object or
     * its fields.
     */
