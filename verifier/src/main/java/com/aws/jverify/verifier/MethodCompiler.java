...
public class MethodCompiler {
    ...
    private WhileStmt translateLoop(JCTree.JCStatement loop,
        ...
        var header = new MethodLikeContract(loop);
    ...
    private void checkLoopHeaderAndSetupLabels(JCTree.JCStatement loop, List<Label> labels, MethodLikeContract header) {
    ...
    /**
     * @see #translateHeader(List, MethodLikeContract)
     */
    public List<JCTree.JCStatement> translateHeader(JCTree.JCStatement statement, MethodLikeContract header) {
     ...
     * appending the translations to the given {@link MethodLikeContract},
     ...
     */
    public List<JCTree.JCStatement> translateHeader(List<JCTree.JCStatement> statements, MethodLikeContract header) {
