...
package com.aws.jverify.javacforked;
...
//     */
//    public Map<ClassSymbol, com.sun.tools.javac.util.List<JCTree>> prunedTree = new WeakHashMap<>();
//
...
//     */
//    com.sun.tools.javac.util.List<Name> enumNamesFor(ClassSymbol c) {
//
...
//        for (com.sun.tools.javac.util.List<JCTree> defs = classDef.defs; defs.nonEmpty(); defs=defs.tail) {
...
//     */
//    Map<ClassSymbol, com.sun.tools.javac.util.List<VarSymbol>> freevarCache;
//
...
//         */
//        com.sun.tools.javac.util.List<VarSymbol> fvs;
//
//        FreeVarCollector(ClassSymbol clazz) {
//            this.clazz = clazz;
//            this.owner = clazz.owner;
//            this.fvs = com.sun.tools.javac.util.List.nil();
//        }
//
//        /** Add free variable to fvs list unless it is already there.
//         */
//        private void addFreeVar(VarSymbol v) {
//            for (com.sun.tools.javac.util.List<VarSymbol> l = fvs; l.nonEmpty(); l = l.tail)
//                if (l.head == v) return;
//            fvs = fvs.prepend(v);
//        }
//
...
//            com.sun.tools.javac.util.List<VarSymbol> fvs = freevarCache.get(c);
//            if (fvs != null) {
//                for (com.sun.tools.javac.util.List<VarSymbol> l = fvs; l.nonEmpty(); l = l.tail) {
//                    addFreeVar(l.head);
//                }
...
//     */
//    com.sun.tools.javac.util.List<VarSymbol> freevars(ClassSymbol c)  {
//        com.sun.tools.javac.util.List<VarSymbol> fvs = freevarCache.get(c);
//        if (fvs != null) {
//            return fvs;
//        }
...
//            final com.sun.tools.javac.util.List<Name> idents = enumNamesFor((ClassSymbol)enumClass);
//            if (idents != null)
...
//
//        final com.sun.tools.javac.util.List<Name> enumNames;
//
//        CompileTimeEnumMapping(com.sun.tools.javac.util.List<Name> enumNames) {
...
//                        .NewArray(make.Type(syms.intType), com.sun.tools.javac.util.List.of(size), null)
...
//                        forEnum.type,
//                        com.sun.tools.javac.util.List.nil());
//                com.sun.tools.javac.util.List<JCCatch> catcher = com.sun.tools.javac.util.List.<JCCatch>nil()
//                        .prepend(make.Catch(make.VarDef(new VarSymbol(PARAMETER, names.ex,
//                                                syms.noSuchFieldErrorType,
//                                                syms.noSymbol),
//                                        null),
//                                make.Block(0, com.sun.tools.javac.util.List.nil())));
...
//                    JCStatement _try = make.Try(make.Block(0, com.sun.tools.javac.util.List.of(exec)), catcher, null);
//                    stmts.append(_try);
//                }
//
...
//     */
//    JCNewClass makeNewClass(Type ctype, com.sun.tools.javac.util.List<JCExpression> args) {
//        JCNewClass tree = make.NewClass(null,
//                null, make.QualIdent(ctype.tsym), args, null);
//        tree.constructor = rs.resolveConstructor(
//                make_pos, attrEnv, ctype, TreeInfo.types(args), com.sun.tools.javac.util.List.nil());
//        tree.type = ctype;
//        return tree;
//    }
//
...
//                    names.valueOf,
//                    syms.stringType,
//                    com.sun.tools.javac.util.List.of(tree.type));
//            return make.App(make.QualIdent(valueOfSym), com.sun.tools.javac.util.List.of(tree));
//        }
//    }
//
...
//        ctype.interfaces_field = com.sun.tools.javac.util.List.nil();
//
...
//                com.sun.tools.javac.util.List.nil(),
//                null, com.sun.tools.javac.util.List.nil(), com.sun.tools.javac.util.List.nil());
//        cdef.sym = c;
//        cdef.type = c.type;
//
...
//     */
//    void checkConflicts(com.sun.tools.javac.util.List<JCTree> translatedTrees) {
...
//     */
//    private MethodSymbol lookupMethod(DiagnosticPosition pos, Name name, Type qual, com.sun.tools.javac.util.List<Type> args) {
//        return rs.resolveInternalMethod(pos, attrEnv, qual, name, args, com.sun.tools.javac.util.List.nil());
//    }
//
...
//        for (com.sun.tools.javac.util.List<ClassSymbol> l = accessConstrTags; l.nonEmpty(); l = l.tail) {
...
//     */
//    private com.sun.tools.javac.util.List<ClassSymbol> accessConstrTags;
//
...
//        com.sun.tools.javac.util.List<Type> argtypes;      // The argument types of the access method.
//        Type restype;             // The result type of the access method.
//        com.sun.tools.javac.util.List<Type> thrown;        // The thrown exceptions of the access method.
//        switch (vsym.kind) {
//            case VAR:
...
//                        argtypes = com.sun.tools.javac.util.List.of(syms.objectType);
//                    else
//                        argtypes = operator.type.getParameterTypes().tail;
//                } else if (acode == AccessCode.ASSIGN.code)
//                    argtypes = com.sun.tools.javac.util.List.of(vsym.erasure(types));
//                else
//                    argtypes = com.sun.tools.javac.util.List.nil();
//                restype = vsym.erasure(types);
//                thrown = com.sun.tools.javac.util.List.nil();
//                break;
//            case MTH:
...
//        com.sun.tools.javac.util.List<JCTree> infoList = prunedTree.get(currentClass);
//        infoList = (infoList == null) ? com.sun.tools.javac.util.List.of(tree) : infoList.prepend(tree);
...
//            if (aconstr == null) {
//                com.sun.tools.javac.util.List<Type> argtypes = constr.type.getParameterTypes();
...
//        com.sun.tools.javac.util.List<JCExpression> args;    // Any additional arguments to be passed along.
//        if ((sym.flags() & STATIC) != 0) {
//            ref = make.Ident(sym);
...
//        }
//        md.body = make.Block(0, com.sun.tools.javac.util.List.of(stat));
//
//        // Make sure all parameters, result types and thrown exceptions
//        // are accessible.
//        for (com.sun.tools.javac.util.List<JCVariableDecl> l = md.params; l.nonEmpty(); l = l.tail)
//            l.head.vartype = access(l.head.vartype);
//        md.restype = access(md.restype);
//        for (com.sun.tools.javac.util.List<JCExpression> l = md.thrown; l.nonEmpty(); l = l.tail)
...
//        md.body =
//                make.Block(0, com.sun.tools.javac.util.List.of(
//                        make.Call(
//                                make.App(
//                                        callee,
...
//     *  parameters.
//     */
//    com.sun.tools.javac.util.List<VarSymbol> outerThisStack;
//
...
//     */
//    com.sun.tools.javac.util.List<JCVariableDecl> freevarDefs(int pos, com.sun.tools.javac.util.List<VarSymbol> freevars, Symbol owner) {
...
//        com.sun.tools.javac.util.List<JCVariableDecl> defs = com.sun.tools.javac.util.List.nil();
//        Set<Name> proxyNames = new HashSet<>();
//        for (com.sun.tools.javac.util.List<VarSymbol> l = freevars; l.nonEmpty(); l = l.tail) {
//            VarSymbol v = l.head;
//            int index = 0;
//            Name proxyName;
//            do {
...
//     */
//    com.sun.tools.javac.util.List<JCExpression> loadFreevars(DiagnosticPosition pos, com.sun.tools.javac.util.List<VarSymbol> freevars) {
//        com.sun.tools.javac.util.List<JCExpression> args = com.sun.tools.javac.util.List.nil();
//        for (com.sun.tools.javac.util.List<VarSymbol> l = freevars; l.nonEmpty(); l = l.tail)
...
//    }
//
//    private JCBlock makeTwrBlock(com.sun.tools.javac.util.List<JCTree> resources, JCBlock block, int depth) {
...
//        }
//
//        JCBlock finallyClause = make.Block(BODY_ONLY_FINALIZE, com.sun.tools.javac.util.List.of(bodyCloseStatement));
//        make.at(oldPos);
//
...
//                        names.addSuppressed,
//                        com.sun.tools.javac.util.List.of(make.Ident(suppressedException))));
//        JCBlock closeResourceTryBlock =
//                make.Block(0L, com.sun.tools.javac.util.List.of(makeResourceCloseInvocation(resourceUse)));
//        JCVariableDecl catchSuppressedDecl = make.VarDef(suppressedException, null);
//        JCBlock catchSuppressedBlock = make.Block(0L, com.sun.tools.javac.util.List.of(addSuppressedStatement));
//        com.sun.tools.javac.util.List<JCCatch> catchSuppressedClauses =
//                com.sun.tools.javac.util.List.of(make.Catch(catchSuppressedDecl, catchSuppressedBlock));
...
//        JCBlock exceptionalCloseBlock = make.Block(0L, com.sun.tools.javac.util.List.of(exceptionalCloseStatement, exceptionalRethrow));
...
//                com.sun.tools.javac.util.List.of(exceptionalCatchClause),
//                finallyClause);
//
...
//        com.sun.tools.javac.util.List<VarSymbol> ots = outerThisStack;
//        if (ots.isEmpty()) {
...
//    private JCMethodInvocation makeCall(JCExpression left, Name name, com.sun.tools.javac.util.List<JCExpression> args) {
...
//                JCBlock clinit = make.Block(STATIC, com.sun.tools.javac.util.List.of(dummy));
...
//        JCExpression res = make.LetExpr(com.sun.tools.javac.util.List.of(make.Exec(expr1)), expr2);
//        res.type = expr2.type;
//        return res;
//    }
//
...
//     */
//    public <T extends JCExpression> com.sun.tools.javac.util.List<T> translate(com.sun.tools.javac.util.List<T> trees, Type type) {
//        if (trees == null) return null;
//        for (com.sun.tools.javac.util.List<T> l = trees; l.nonEmpty(); l = l.tail)
...
//        createInfoClass(com.sun.tools.javac.util.List.nil(), tree.sym.module_info);
//    }
//
//    private void createInfoClass(com.sun.tools.javac.util.List<JCAnnotation> annots, ClassSymbol c) {
//        long flags = Flags.ABSTRACT | Flags.INTERFACE;
//        JCClassDecl infoClass =
//                make.ClassDef(make.Modifiers(flags, annots),
//                        c.name, com.sun.tools.javac.util.List.nil(),
//                        null, com.sun.tools.javac.util.List.nil(), com.sun.tools.javac.util.List.nil());
//        infoClass.sym = c;
...
//        com.sun.tools.javac.util.List<VarSymbol> prevOuterThisStack = outerThisStack;
//
...
//        com.sun.tools.javac.util.List<JCVariableDecl> fvdefs = freevarDefs(
...
//                encl.trans_local = com.sun.tools.javac.util.List.nil();
//            }
...
//        // list `tree.defs'.
//        com.sun.tools.javac.util.List<JCTree> seen = com.sun.tools.javac.util.List.nil();
//        while (tree.defs != seen) {
//            com.sun.tools.javac.util.List<JCTree> unseen = tree.defs;
//            for (com.sun.tools.javac.util.List<JCTree> l = unseen; l.nonEmpty() && l != seen; l = l.tail) {
...
//
//        for (com.sun.tools.javac.util.List<JCVariableDecl> l = fvdefs; l.nonEmpty(); l = l.tail) {
...
//                        com.sun.tools.javac.util.List<JCStatement> initializer = com.sun.tools.javac.util.List.of(initOuterThis(mdef.body.pos, mdef.params.head.sym));
...
//        result = make_at(tree.pos()).Block(SYNTHETIC, com.sun.tools.javac.util.List.nil());
//    }
//
...
//    }
//
//    com.sun.tools.javac.util.List<JCTree> generateMandatedAccessors(JCClassDecl tree) {
//        com.sun.tools.javac.util.List<JCVariableDecl> fields = TreeInfo.recordFields(tree);
...
//                            com.sun.tools.javac.util.List.of(make.Return(make.Ident(field)))));
...
//        for (com.sun.tools.javac.util.List<JCTree> defs = tree.defs;
//             defs.nonEmpty();
//             defs=defs.tail) {
...
//                new MethodType(com.sun.tools.javac.util.List.nil(), arrayType, com.sun.tools.javac.util.List.nil(), tree.type.tsym),
//                tree.type.tsym);
//        enumDefs.append(make.MethodDef(valuesMethod, make.Block(0, com.sun.tools.javac.util.List.of(make.Return(newArray)))));
...
//                tree.type, com.sun.tools.javac.util.List.nil());
//        com.sun.tools.javac.util.List<JCStatement> valuesBody;
//        if (useClone()) {
...
//            valuesBody = com.sun.tools.javac.util.List.of(make.Return(valuesResult));
//        } else {
...
//                    com.sun.tools.javac.util.List.of(make.Select(make.Ident(valuesVar), syms.lengthVar)),
//                    null);
...
//                                new MethodType(com.sun.tools.javac.util.List.of(syms.objectType,
//                                        syms.intType,
//                                        syms.objectType,
//                                        syms.intType,
//                                        syms.intType),
...
//                                    systemArraycopyMethod),
//                            com.sun.tools.javac.util.List.of(make.Ident(valuesVar), make.Literal(0),
...
//            valuesBody = com.sun.tools.javac.util.List.of(decl, copy, ret);
//        }
//
...
//                names.valueOf,
//                tree.sym.type,
//                com.sun.tools.javac.util.List.of(syms.stringType));
...
//                                names.valueOf,
//                                com.sun.tools.javac.util.List.of(e_class, nameVal))));
//        JCMethodDecl valueOf = make.MethodDef(valueOfSym,
//                make.Block(0, com.sun.tools.javac.util.List.of(enum_ValueOf)));
...
//    }
//
//    private com.sun.tools.javac.util.List<VarSymbol> recordVars(Type t) {
//        com.sun.tools.javac.util.List<VarSymbol> vars = com.sun.tools.javac.util.List.nil();
//        while (!t.hasTag(NONE)) {
//            if (t.hasTag(CLASS)) {
...
//        make_at(tree.pos());
//        com.sun.tools.javac.util.List<VarSymbol> vars = recordVars(tree.type);
...
//        tree.defs = tree.defs.appendList(com.sun.tools.javac.util.List.of(
...
//    }
//
//    JCTree generateRecordMethod(JCClassDecl tree, Name name, com.sun.tools.javac.util.List<VarSymbol> vars, MethodHandleSymbol[] getterMethHandles) {
//        make_at(tree.pos());
//        boolean isEquals = name == names.equals;
//        MethodSymbol msym = lookupMethod(tree.pos(),
//                name,
//                tree.sym.type,
//                isEquals ? com.sun.tools.javac.util.List.of(syms.objectType) : com.sun.tools.javac.util.List.nil());
...
//            }
//
//            com.sun.tools.javac.util.List<Type> staticArgTypes = com.sun.tools.javac.util.List.of(syms.classType,
//                    syms.stringType,
...
//                    com.sun.tools.javac.util.List.of(syms.methodHandleLookupType,
//                            syms.stringType,
...
//            if (!isEquals) {
//                proxyCall = make.Apply(com.sun.tools.javac.util.List.nil(), qualifier, com.sun.tools.javac.util.List.of(make.Ident(_this)));
//            } else {
//                VarSymbol o = msym.params.head;
//                o.adr = 0;
//                proxyCall = make.Apply(com.sun.tools.javac.util.List.nil(), qualifier, com.sun.tools.javac.util.List.of(make.Ident(_this), make.Ident(o)));
//            }
//            proxyCall.type = qualifier.type;
//            return make.MethodDef(msym, make.Block(0, com.sun.tools.javac.util.List.of(make.Return(proxyCall))));
//        } else {
//            return make.Block(SYNTHETIC, com.sun.tools.javac.util.List.nil());
//        }
//    }
//
//    private String argsTypeSig(com.sun.tools.javac.util.List<Type> typeList) {
...
//            JCClassDecl tree,
//            MethodSymbol msym,
//            com.sun.tools.javac.util.List<Type> staticArgTypes,
//            LoadableConstant[] staticArgValues,
//            Name bootstrapName,
//            Name argName,
//            boolean isStatic) {
//        MethodSymbol bsm = rs.resolveInternalMethod(tree.pos(), attrEnv, site,
//                bootstrapName, staticArgTypes, com.sun.tools.javac.util.List.nil());
//
//        MethodType indyType = msym.type.asMethodType();
//        indyType = new MethodType(
//                isStatic ? com.sun.tools.javac.util.List.nil() : indyType.argtypes.prepend(tree.sym.type),
//                indyType.restype,
//                indyType.thrown,
//                syms.methodClass
//        );
...
//            proxies = new HashMap<>(proxies);
//            com.sun.tools.javac.util.List<VarSymbol> prevOuterThisStack = outerThisStack;
//            com.sun.tools.javac.util.List<VarSymbol> fvs = freevars(currentClass);
//            JCVariableDecl otdef = null;
//            if (currentClass.hasOuterInstance())
//                otdef = outerThisDef(tree.pos, m);
//            com.sun.tools.javac.util.List<JCVariableDecl> fvdefs = freevarDefs(tree.pos, fvs, m, PARAMETER);
//
...
//            if (fvs.nonEmpty()) {
//                com.sun.tools.javac.util.List<Type> addedargtypes = com.sun.tools.javac.util.List.nil();
//                for (com.sun.tools.javac.util.List<VarSymbol> l = fvs; l.nonEmpty(); l = l.tail) {
//                    m.capturedLocals =
...
//            if (added.nonEmpty()) {
//                com.sun.tools.javac.util.List<JCStatement> initializers = added.toList();
...
//            }
//
//            result = make.LetExpr(com.sun.tools.javac.util.List.of(var), exactnessCheck)
//                    .setType(syms.booleanType);
//        } else {
//            tree.expr = translate(tree.expr);
...
//                com.sun.tools.javac.util.List.of(pair.from.type));
//
...
//
//        JCExpression exactnessCheck = make.Apply(com.sun.tools.javac.util.List.nil(),
//                select,
...
//        com.sun.tools.javac.util.List<Type> argTypes = tree.constructor.type.getParameterTypes();
...
//            com.sun.tools.javac.util.List<JCExpression> exnArgs = (tree.detail == null) ?
//                    com.sun.tools.javac.util.List.nil() : com.sun.tools.javac.util.List.of(translate(tree.detail));
...
//        com.sun.tools.javac.util.List<Type> argtypes = meth.type.getParameterTypes();
...
//                com.sun.tools.javac.util.List<JCVariableDecl> params = currentMethodDef.params;
...
//    }
//
//    com.sun.tools.javac.util.List<JCExpression> boxArgs(com.sun.tools.javac.util.List<Type> parameters, com.sun.tools.javac.util.List<JCExpression> _args, Type varargsElement) {
//        com.sun.tools.javac.util.List<JCExpression> args = _args;
...
//            app.args = com.sun.tools.javac.util.List.of(tree.rhs).prependList(app.args);
//            result = app;
//        } else {
//            result = tree;
//        }
...
//                    ? makeString(tree.rhs)
//                    : tree.rhs;
//            app.args = com.sun.tools.javac.util.List.of(rhs).prependList(app.args);
//            result = app;
//        } else {
//            result = tree;
//        }
...
//        com.sun.tools.javac.util.List<Type> formals = tree.operator.type.getParameterTypes();
...
//
//        com.sun.tools.javac.util.List<JCStatement> loopinit = com.sun.tools.javac.util.List.of(arraycachedef, lencachedef, indexdef);
...
//        JCBlock body = make.
//                Block(0, com.sun.tools.javac.util.List.of(loopvardef, tree.body));
//
//        result = translate(make.
//                ForLoop(loopinit,
//                        cond,
//                        com.sun.tools.javac.util.List.of(step),
//                        body));
...
//        JCBlock body = make.Block(0, com.sun.tools.javac.util.List.of(indexDef, tree.body));
//        body.endpos = TreeInfo.endPos(tree.body);
//        result = translate(make.
//                ForLoop(com.sun.tools.javac.util.List.of(init),
//                        cond,
//                        com.sun.tools.javac.util.List.nil(),
//                        body));
//        patchTargets(body, tree, result);
...
//        com.sun.tools.javac.util.List<JCCase> cases = tree.patternSwitch ? addDefaultIfNeeded(tree.patternSwitch,
...
//        com.sun.tools.javac.util.List<JCCase> cases = addDefaultIfNeeded(tree.patternSwitch, tree.wasEnumSelector, tree.cases);
//        handleSwitch(tree, tree.selector, cases);
//    }
//
//    private com.sun.tools.javac.util.List<JCCase> addDefaultIfNeeded(boolean patternSwitch, boolean wasEnumSelector,
//                                                                     com.sun.tools.javac.util.List<JCCase> cases) {
...
//            com.sun.tools.javac.util.List<JCExpression> params = matchException ? com.sun.tools.javac.util.List.of(makeNull(), makeNull())
//                    : com.sun.tools.javac.util.List.nil();
//            JCThrow thr = make.Throw(makeNewClass(exception, params));
//            JCCase c = make.Case(JCCase.STATEMENT, com.sun.tools.javac.util.List.of(make.DefaultCaseLabel()), null, com.sun.tools.javac.util.List.of(thr), null);
...
//    }
//
//    private void handleSwitch(JCTree tree, JCExpression selector, com.sun.tools.javac.util.List<JCCase> cases) {
...
//                    //case C2:
//                    //case C3: ...
//                    com.sun.tools.javac.util.List<JCCaseLabel> patterns = c.labels;
//                    while (patterns.tail.nonEmpty()) {
//                        convertedCases.append(make_at(c.pos()).Case(JCCase.STATEMENT,
//                                com.sun.tools.javac.util.List.of(patterns.head),
//                                null,
//                                com.sun.tools.javac.util.List.nil(),
//                                null));
...
//    }
//
//    public JCTree visitEnumSwitch(JCTree tree, JCExpression selector, com.sun.tools.javac.util.List<JCCase> cases) {
...
//                            ordinalMethod)));
//            newSelector =
//                    make.LetExpr(com.sun.tools.javac.util.List.of(var),
...
//                }
//                newCases.append(make.Case(JCCase.STATEMENT, com.sun.tools.javac.util.List.of(make.ConstantCaseLabel(pat)), null, c.stats, null));
//            } else {
//                newCases.append(c);
//            }
//        }
...
//    }
//
//    public JCTree visitStringSwitch(JCTree tree, JCExpression selector, com.sun.tools.javac.util.List<JCCase> caseList) {
...
//                    names.hashCode,
//                    com.sun.tools.javac.util.List.nil()).setType(syms.intType);
...
//                            names.equals,
//                            com.sun.tools.javac.util.List.of(make.Literal(caseLabel)));
...
//                        com.sun.tools.javac.util.List.of(make.ConstantCaseLabel(make.Literal(hashCode))),
//                        null,
//                        lb.toList(),
//                        null));
//            }
...
//                }
//
//                lb.append(make.Case(JCCase.STATEMENT, caseExpr == null ? com.sun.tools.javac.util.List.of(make.DefaultCaseLabel())
//                                : com.sun.tools.javac.util.List.of(make.ConstantCaseLabel(caseExpr)),
//                        null,
//                        oneCase.stats, null));
//            }
//
...
//    }
//
//    private JCTree visitBoxedPrimitiveSwitch(JCTree tree, JCExpression selector, com.sun.tools.javac.util.List<JCCase> cases) {
//        JCExpression newSelector;
//
//        if (cases.stream().anyMatch(c -> TreeInfo.isNullCaseLabel(c.labels.head))) {
...
//                                    makeLit(syms.intType, nullValue))
//                            .setType(syms.intType);
//            newSelector = make.LetExpr(com.sun.tools.javac.util.List.of(var), nullCheck).setType(syms.intType);
//        } else {
...
//        for (com.sun.tools.javac.util.List<JCExpression> t = tree.dims; t.tail != null; t = t.tail)
...
//     */
//    public com.sun.tools.javac.util.List<JCTree> translateTopLevelClass(Env<AttrContext> env, JCTree cdef, TreeMaker make) {
...
//            outerThisStack = com.sun.tools.javac.util.List.nil();
//            accessNums = new HashMap<>();
//            accessSyms = new HashMap<>();
//            accessConstrs = new HashMap<>();
//            accessConstrTags = com.sun.tools.javac.util.List.nil();
//            accessed = new ListBuffer<>();
//            translate(cdef, (JCExpression)null);
//            for (com.sun.tools.javac.util.List<Symbol> l = accessed.toList(); l.nonEmpty(); l = l.tail)
