...
import org.strata.jverify.verifier.compiler.position.*;
...
public class Reporter {
    ...
    public static Range getPositionRange(IOrigin origin) {
        ...
        return new Range(
            new org.strata.jverify.common.Position(range.startToken().line(), range.startToken().col()),
            new org.strata.jverify.common.Position(endToken.line(), endToken.col()));
    }
