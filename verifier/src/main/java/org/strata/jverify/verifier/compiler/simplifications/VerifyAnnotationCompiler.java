...
import org.strata.jverify.verifier.IntervalTree;
import org.strata.jverify.verifier.JavaMethodVerificationStatus;
import org.strata.jverify.verifier.compiler.PositionCalculator;
...
public class VerifyAnnotationCompiler extends TreeScanner {
    ...
    private void addMethodToIntervalTree(JCTree.JCMethodDecl methodDecl, boolean shouldVerify) {
        ...
        if (!methodStatusPerUri.containsKey(sourceFileURI) || JVerifyUtils.isSynthetic(methodDecl.getModifiers().flags)
    ...
    public HashMap<URI, IntervalTree<Integer, JavaMethodVerificationStatus>> getMethodStatusPerUri() {
