...
public record Procedure(Identifier name, java.util.List<Parameter> inputs, java.util.List<Parameter> outputs, java.util.List<Condition> preconditions, AstNode<StmtExpr> decreases, boolean isFunctional, Body body, AstNode<StmtExpr> invokeOn, java.util.List<AstNode<StmtExpr>> axioms) implements ToIon {
