package com.aws.jverify.verifier.tests.offforpackageandchildren;
...
// Testing putting @Verify(value = false, overrideChildren = true) at the package level

@JVerifyTest(exitCode = 4, dafnyVerified = 0, dafnyErrors = 1)
public class VerifyOffByDefaultForPackage {}
