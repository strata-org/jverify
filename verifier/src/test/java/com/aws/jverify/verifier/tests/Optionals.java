// ^ /builtin-contracts.java(577:22-577:27) Related location: this proposition could not be proved
...
@JVerifyTest(exitCode = 4, dafnyVerified = 11, dafnyErrors = 2, useBuiltinContracts = true)
