// ^ /builtin-contracts.java(585:22-585:27) Related location: this proposition could not be proved
...
@JVerifyTest(exitCode = 4, dafnyVerified = 12, dafnyErrors = 2, useBuiltinContracts = true)
