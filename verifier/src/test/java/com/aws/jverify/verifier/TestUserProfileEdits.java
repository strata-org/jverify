...
public class TestUserProfileEdits {
    ...
    public void edits() throws IOException {
        ...
        var firstTestAnnotation = JVerifyTestEngine.makeJVerifyTestAnnotation(6, 1);
        ...
        var secondTestAnnotation = JVerifyTestEngine.makeJVerifyTestAnnotation(6, 1);
        ...
        var thirdTestAnnotation = JVerifyTestEngine.makeJVerifyTestAnnotation(7, 1);
        ...
        var fourthTestAnnotation = JVerifyTestEngine.makeJVerifyTestAnnotation(8, 0);
