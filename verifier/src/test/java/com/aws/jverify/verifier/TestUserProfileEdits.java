...
public class TestUserProfileEdits {
    ...
    public void edits() throws IOException {
        ...
        var firstTestAnnotation = JVerifyTestEngine.makeJVerifyTestAnnotation(15, 1);
        ...
        var secondTestAnnotation = JVerifyTestEngine.makeJVerifyTestAnnotation(15, 1);
        ...
        var thirdTestAnnotation = JVerifyTestEngine.makeJVerifyTestAnnotation(16, 1);
        ...
        var fourthTestAnnotation = JVerifyTestEngine.makeJVerifyTestAnnotation(17, 0);
