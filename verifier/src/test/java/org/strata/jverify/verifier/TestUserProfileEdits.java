...
import org.strata.jverify.common.AnnotatedRange;
import org.strata.jverify.common.Common;
import org.strata.jverify.testengine.JVerifyTestEngine;
import org.strata.jverify.testengine.TestMarkup;
...
public class TestUserProfileEdits {
    ...
    public void edits() throws IOException {
        ...
        var secondTestAnnotation = JVerifyTestEngine.makeJVerifyTestAnnotation(start, 1);
        ...
        var thirdTestAnnotation = JVerifyTestEngine.makeJVerifyTestAnnotation(start + 1, 1);
        ...
        var fourthTestAnnotation = JVerifyTestEngine.makeJVerifyTestAnnotation(start + 2, 0);
