...
```java
{{#include ../../../examples/src/test/java/org/strata/jverify/examples/UserProfile.java}}
```

#### Ensures data satisfies constraints
```java
{{#include ../../../examples/src/test/java/org/strata/jverify/examples/DataConsistency.java}}
```
...
```java
{{#include ../../../examples/src/test/java/org/strata/jverify/examples/SumCache.java}}
```
...
```java
{{#include ../../../examples/src/test/java/org/strata/jverify/examples/ProcessRangesIfAble.java}}
```
...
```java
{{#include ../../../examples/src/test/java/org/strata/jverify/examples/ValidRangesJackson.java}}
```
...
```java
{{#include ../../../examples/src/test/java/org/strata/jverify/examples/MinimumPricePercentage.java}}
```
...
```java
{{#include ../../../examples/src/test/java/org/strata/jverify/examples/BinarySearch.java}}
```
